...
class LinkedList:
    def __init__(self, data: Iterable = None):
        ...
        self.len = 0  # атрибут, хранящий длину последовательности
    ...
    def init_linked_list(self, data: Iterable):
        ...
        self.len = len(self.list_nodes)  # устанавливаем длину последовательности
    ...
    def step_by_step_on_nodes(self, index: int) -> Node:
        ...
        if not 0 <= index < self.len:  # проверка корректности границ индекса
            raise IndexError
...
if __name__ == '__main__':
    ...
    # с помощью цикла for распечатать в столбик все значения связного списка
